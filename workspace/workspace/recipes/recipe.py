        ...
        for i in range(len(path)):
            ...
            if C == 2:
                ...
                if i == 0: # first motion jmove
                    #self.core.robot_api.jmove_no_collision(joint=J, vel=vaj_map["jmove"][0]*self.speed_factor, accel=vaj_map["jmove"][1]*self.speed_factor, jerk=vaj_map["jmove"][2]*self.speed_factor)
