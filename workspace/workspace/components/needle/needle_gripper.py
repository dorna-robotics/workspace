...
class NeedleGripper(PumpedTool, Gripper):
    # Geometry measured off needle_gripper.glb, z = 0 at the
    # tool-changer flange, +z toward the tip. One collision box
    # bounding the whole tool: x -35.0..34.35, y +/-21.5, z 0..173.387
    # — bottom face flush with tcp.
    # The needle point sits at z = 169.10; the stripper weight's bottom
    # face at z = 173.387 hangs below it at rest and is the tool's
    # working reference — tcp/tip live there.
    DEFAULTS = dict(
        anchors={"body": {"center": [0, 0, 0, 0, 0, 0], "tcp":[0, 0, 173.387, 0, 0, 0],  "tip":[0, 0, 173.387, 0, 0, 0]}},
        collision_box =
            {"body":[
