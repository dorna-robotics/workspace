...
class AdapterDiscHolder(Adapter):
    DEFAULTS = dict(
        anchors={"body": {"center":[0, 0, 0, 0, 0, 0], "place": [0, 0, 0, 0, 0, 0], "top": [0, 0, 6, 0, 0, 0],
                        "hole_1":[-112.5, -12.5, 0, 0, 0, 0], "hole_0": [112.5, 12.5, 0, 0, 0, 0],
                        "clb_1": [-112.5, -12.5, 0, 0, 0, 90], "clb_0": [112.5, 12.5, 0, 0, 0, 90], "clb_2": [112.5, -12.5, 0, 0, 0, 90], "clb_3": [-112.5, 12.5, 0, 0, 0, 90],
}},
        collision_box=
            {"body":[
