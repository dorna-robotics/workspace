...
class AdapterPlateAutosampler2ml4x14(Adapter):
    ...
    DEFAULTS = dict(
        anchors={"body": {"center":[0, 0, 0, 0, 0, 0], "place": [0, 0, 0, 0, 0, 0], "top": [0, 0, 0, 0, 0, 0],
                ...
                # — ON the plate face (was 100, jig height; plate-face probing
                # with the rack lifted off, like adapter_capholder_*).
                # hole_0/hole_1 (the screws at x = +/-100) take their own grid
                # holes; these use OTHER free holes, every coordinate a
                # multiple of 25 so each lands on a real hole. 4 at the
                # corners of a 250 x 100 grid rectangle (the 285 x 85 rack
                # footprint sits inside in y) + 2 near the centre, clear of
                # the +/-100 screws.
                "clb_0": [125, 50, 0, 0, 0, 0], "clb_1": [-125, 50, 0, 0, 0, 0], "clb_2": [-125, -50, 0, 0, 0, 0], "clb_3": [125, -50, 0, 0, 0, 0],
