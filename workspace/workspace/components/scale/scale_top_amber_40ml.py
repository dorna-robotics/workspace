...
# ScaleTop Amber 40ml — static fixture that sits on the scale pan. Placeholder
...
class ScaleTopAmber40ml:
    DEFAULTS = dict(
        ...
        collision_box =
            {"body":[
                {"pose":[0.0, 0.0, 82.0/2, 0.0, 0.0, 0.0], "scale":[83.0, 83.0, 82.0], "padding_enabled": True}#[xyzabc] , [lx,ly,lz]
        ]},
    )
