...
class Gripper4Finger(Gripper):
    DEFAULTS = dict(
        ...
        anchors={"body": {"center": [0, 0, 0, 0, 0, 0], "tcp":[0, 0, 66.5-1+2.5, 0, 0, -45], "tip": [0, 0, 69.5+2.5, 0, 0, -45]}},
        collision_box = 
            {"body":[
                {"pose":[0.0, 0.0, 34+2.5/2, 0.0, 0.0, 0.0], "scale":[47.0, 47.0, 71+2.5]},#[xyzabc] , [lx,ly,lz]
        ]},
        #cfg
