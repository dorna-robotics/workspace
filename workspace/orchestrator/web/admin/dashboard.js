        ...
        <div class="wc-actions">
          ${!launched
            ...
            : `<button class="btn btn-sm btn-primary action-btn" data-cmd="start"   title="Start"   ${running  ? "disabled" : ""}><svg width="11" height="11" viewBox="0 0 24 24" fill="currentColor"><polygon points="5 3 19 12 5 21"/></svg></button>
               ...
               <button class="btn btn-sm btn-danger action-btn"  data-cmd="stop"    title="Stop">Stop</button>
               <button class="btn btn-sm btn-ghost btn-icon action-btn" data-cmd="kill" title="Kill (emergency)"><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></button>`
          }
