...
function renderKwargsForm(container, schema, values, frozen = false, wsNameParam = "") {
  container.innerHTML = "";
      ...
      if (!frozen) {
        ...
        fileInput.addEventListener("change", async () => {
          ...
          try {
            ...
            const resp = await fetch(`/workspace/${encodeURIComponent(wsNameParam)}/upload/${encodeURIComponent(key)}`, {
              method: "POST",
              body: fd,
            });
