...
def make_app(port=5000):
    ...
    routes = [
        ...
        (r"/scene-builder/api/instantiate_batch", InstantiateBatchHandler),
        ...
        (r"/scene-builder/api/replays", ReplayListHandler),
        (r"/scene-builder/api/replay", ReplayFileHandler),
