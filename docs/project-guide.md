...
## 5. Protocol — `protocol/protocol.yaml`

Defines the workflow: what states exist, their order, checks, and tools.
...
## 6. Recipes — `recipes/recipes.yaml`

Maps aliases to recipe classes with their configuration.
...
## 9. Creating a new project — checklist
